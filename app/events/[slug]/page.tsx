  ...
  return (
    <main style={{minHeight:"100vh",background:"#f8fafc",fontFamily:"system-ui,sans-serif"}}>
      <style>{`
        ...
        .info-bar-item { display:flex; align-items:center; gap:10; padding:16px 24px; border-right:1px solid #f3f4f6; flex-shrink:0; }
      ...
      <div className="info-bar">
        ...
        <div className="info-bar-item">
          ...
          <div>
            <div style={{fontSize:11,color:"#9ca3af",fontWeight:500,textTransform:"uppercase",letterSpacing:0.5}}>Wstęp</div>
            <div style={{fontSize:14,fontWeight:700,color:event.is_free?"#16a34a":"#111827"}}>{event.is_free?"Wolny":`Od ${event.price_from} PLN`}</div>
          </div>
        </div>
        ...
        <div className="event-layout">
          ...
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div style={{background:"white",borderRadius:18,padding:"20px 24px",boxShadow:"0 2px 12px rgba(0,0,0,0.07)"}}>
              <div style={{fontSize:13,fontWeight:700,color:"#9ca3af",textTransform:"uppercase",letterSpacing:0.5,marginBottom:14}}>Szczegóły</div>
