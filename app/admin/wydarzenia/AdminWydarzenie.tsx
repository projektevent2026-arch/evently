...
export default function AdminWydarzenie({ eventId }: { eventId?: string }) {
  ...
  const handleGeocode = async () => {
    ...
    try {
      ...
      if (result) {
        setForm(prev => {
          // Ten sam warunek co w formularzu publicznym: nadpisz Miasto
          // tylko gdy wygląda na "przypadkowe" (puste albo powtórzone
          // z adresu) — świadomie inne miasto zostaje nietknięte.
